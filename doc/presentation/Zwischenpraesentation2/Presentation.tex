...
\begin{frame}
 ...
 \begin{figure}
	...
	\begin{minipage}[t]{0.45\textwidth} 
		\centering
		\includegraphics[width=0.8\textwidth]{Images/Raspberry Pi and Camera Open.jpg} 
		\caption*{Aufbau im Gehäuse}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.45\textwidth} 
		\centering
		\includegraphics[width=0.6\textwidth]{Images/Raspberry Pi and Camera Closed.jpg}
