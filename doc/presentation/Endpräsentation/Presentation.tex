...
\begin{frame}
	...
	\begin{enumerate}
		\item Hohe Benutzerfreundlichkeit: Einfach zu Bedienen
		
		\item Preis: Günstig durch Nutzung von Rasberry PIs und Open-Source-Software im Vergleich zu kommerziellen Lösungen
		
		\item Einfachheit des Systems: Besitzt modernen Aufbau, Anpassungen und Erweiterungen Problemlos durchführbar
	\end{enumerate}
\end{frame}
